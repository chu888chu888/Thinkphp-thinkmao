                ...
                <ul class="quick-menu">
                    ...
                    <li class="cart mini-cart mini-cart-no-layer menu">
                        <a id="mc-menu-hd" class="menu-hd" href="#">
                            ...
                            <s></s>
                            购物车
                            <span class="mc-count mc-pt3"><?php echo ($goods_number); ?></span>
                            件
                        </a>
                        <b class="leftline"></b>
                        <b class="rightline"></b>
            ...
            <div class="m-loaded" id="mcart">
                ...
                <div id="topinfo">
                    ...
                    <div id="J_StatusBar" data-total="50" data-limit="45">
                        购物车状态：
                        <div class="bar">
                            <div title="正常宝贝:<?php echo ($goods_number); echo ($mes["unit"]); ?>" style="width: 2px; display: block;" class="normal" data-title="正常宝贝"></div>
                            <div style="display: none;" class="disable" data-title="临时失效宝贝"></div>
                            <div style="display: none;" class="invalid" data-title="永久失效宝贝"></div>
                        </div>
                        <span class="num">
                            <span class="J_TotalNum"><?php echo ($goods_number); ?></span>
                            /50
                        </span>
                    </div>
                    <div class="rgt">
                        <span>
                            商品总价(不含运费)： <em class="m-total-fee"><?php echo ($p_all); ?></em>
                            元
                        </span>
                        <span>
