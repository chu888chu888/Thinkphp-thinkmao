...
<head>
    ...
    <style type="text/css">
        *{padding:0px;margin:0px;font: 14px/20px "Microsoft Yahei 微软雅黑";}
        ...
        #hd_success_html h2{ height: 28px; color:#f6f6f6;background-color:#79B900;font-size:15px; font-weight: bold; text-indent: 10px; line-height: 28px;}
        ...
        #hd_error_html h2{ height: 28px; color:#f6f6f6;background-color:#232323;font-size:15px; font-weight: bold; text-indent: 10px; line-height: 28px;}
