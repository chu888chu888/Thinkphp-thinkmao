...
<head>
    ...
    <script src="__PUBLIC__/Admin/js/list_goods.js"></script>
</head>
 <body>
     <form action="<?php echo U('ListGoods/attr_modify');?>" method="post" id="inventform">
        ...
        <div class="endform" id="gsbu" style="width:100%">
         ...
         <input type="button" value="重置" class="turnoff gsubmit btn" id="as" style="color:#000;"/>            
        </div>        
        </form>
    </body>
</html>