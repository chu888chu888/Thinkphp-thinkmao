<?php if (!defined('THINK_PATH')) exit();?><html>
    <head>
        ...
        <script src="__PUBLIC__/Admin/js/viewedite.js"></script>
        <script type="text/javascript">
            var brands_url = '<?php echo U("AddGood/brands");?>';
            var attr_url = '<?php echo U("AddGood/attr");?>';
            var type_url ='<?php echo U("AddGood/type");?>';
    ...
    <body>
        ...
        <form action="<?php echo U('good_modify');?>" method="post" class="form">
            <div class="innerbox" >
                ...
                <table class="tb">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="name" value="<?php echo ($allmes["gname"]); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="tname">商品单位:</td>
                        <td>
                            <input type="text" name="unit" value="<?php echo ($allmes["unit"]); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="tname">商品货号:</td>
                        <td>
                            <input type="text" name="number" value="<?php echo ($allmes["number"]); ?>"/>
                        </td>
                    </tr>
                    <tr id="clone">
                                                        ...
                                                        <ul class="ul1">
                                                            <?php $db = M("category");$data = $db->where(array("pid"=>$field['id']))->select(); foreach($data as $field){ $field["url"]=U("List/index",array('cid'=>$field['id']));?><li>                                                                   
                                                                       <span ss="{}" class="c3 catename" flag="1"><?php echo ($field['name']); ?><span class="show_status">+</span></span>
                                                                           <ul class="ul1">
                                                                              <?php $db = M("category");$data = $db->where(array("pid"=>$field['id']))->select(); foreach($data as $field){ $field["url"]=U("List/index",array('cid'=>$field['id'])); if(in_array($field['id'],$allmes['cid'])): ?><li ss="{}" class="c4 catename" flag="true" cateid="<?php echo ($field["id"]); ?>" style="background-color:#DB1F26" val="<?php echo ($field['name']); ?>">
                                                                                      <?php else: ?>
                                                                                       <li ss="{}" class="c4 catename" flag="false" cateid="{$field.id}" val="<?php echo ($field['name']); ?>"><?php endif; ?>                                                                                                                                               
                                                                                 <?php echo ($field['name']); ?>                                                                   
                                                                                 </li><?php }; ?>
                                                                           </ul>
                                                                </li><?php }; ?>
                    ...
                    <tr>
                        ...
                        <td style="position:relative">
                            ...
                            <div class="select_char inputstyle" id="res_brand">
                                <input type="button" value="<?php echo ($allmes["brand_name"]); ?>" class="brandval" style="background-color:blue">
                                <input type="button" value="<?php echo ($allmes["bid"]); ?>" name="bid" class="cateid">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="price" value="<?php echo ($allmes["price"]); ?>"/>&nbsp;&nbsp;&nbsp;元
                        </td>
                    </tr>
                    <tr>
                        <td class="tname">市场售价:</td>
                        <td>
                            <input type="text" name="mprice" value="<?php echo ($allmes["mprice"]); ?>"/>&nbsp;&nbsp;&nbsp;元
                        </td>
                    </tr>
    ...
    UE.getEditor('intro');
            ...
            <div class="innerbox">
                <table class="tb ed">
                    <tr>
                        ...
                        <td align="left">
                            <input type="text" name="click" style="width: 60px" value="<?php echo ($allmes["click"]); ?>"/>&nbsp;&nbsp;&nbsp;次
                        </td>
                    </tr>
                    <tr>
                        <td style="width:200px;">是否为推荐商品：</td>
                    <?php if($allmes['recommend'] == 0): ?><td align="left">
                            <input type="button" class="butage" flag="1" style="background-image: url('__PUBLIC__/Common/img/on.jpg')">
                            <input type="hidden"  name="recommend" value="1" >
                        </td>
                        <?php else: ?>
                        <td align="left">
                            <input type="button" class="butage" flag="0">
                    ...
                    <tr>
                        <td style="width:200px;">是否为热卖商品：</td>
                         <?php if($allmes['hot'] == 0): ?><td align="left">
                            <input type="button" class="butage" flag="1" style="background-image: url('__PUBLIC__/Common/img/on.jpg')">
            ...
            <div class="innerbox">
                <table class="tb" id="attr" style="width: auto">
                    <tr id="head_type">
                        <td class="ifont" width="100px;">选择商品类型:</td>
                         <td>                             
                ...
                <ul class="attrtype">
                    <li class="endpoint">Prev</li>
                    <li style="border:none" class="endpoint">Next</li>
                </ul>
            </div>
...
<script type='text/javascript'>
    ...
    UE.getEditor('service');
            ...
            <div class="endform">
            <input type="button" value="确定" class="gsubmit btn btn-primary" id="modify" style="margin-left: 85%"/>
            <input type="reset" value="取消" class="gsubmit btn" style="color:#000"/>
            </div>
        </form>
    </body>
</html>