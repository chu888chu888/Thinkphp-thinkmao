...
(1, 'root', '96e79218965eb72c92a549dd5a330112', '否');
...
CREATE TABLE IF NOT EXISTS `hd_goods_list` (
  ...
  PRIMARY KEY (`id`),
  KEY `gid` (`gid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品列表(不同货品的库存、货号)' AUTO_INCREMENT=196 ;
...
(195, 67, '37,145|38,147', 11, '23243424443', '', 0),
(173, 903, '37,171|38,172', 12, '643334234', '', 0),
(174, 89, '37,170|38,172', 12, '123143243', '1359343490641', 56),
(194, 423, '37,144|38,147', 11, 'a2212323', '1361716992103', 2334),
...
CREATE TABLE IF NOT EXISTS `hd_order_list` (
  ...
  KEY `gid` (`gid`),
  KEY `oid` (`oid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单商品列表' AUTO_INCREMENT=13 ;
