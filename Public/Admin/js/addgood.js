$(function(){
    $('.addtype').click(function(){
        var obj = $('#clone').clone(true);
        obj.children('.tname').text('');
        obj.children('td').children('input').attr('class','deltype  button').css('color','red').css('background-color','#fff').val('del-');
        obj.insertAfter($(this).parent().parent());
    })
