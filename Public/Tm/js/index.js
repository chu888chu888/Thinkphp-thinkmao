...
//                                 obj.eq(1).css("background-color","#88766E").children("a").css("color","#fff").end().slideUp("fast",function(){
                                box.animate({
                                    height: '55px'
                                },0,function(){
                                    obj.eq(0).slideUp("fast",function(){
//                                        obj.eq(0).css("background-color","#88766E").children("a").css("color","#fff").end().slideUp("fast",function(){
                                        box.animate({
                                            height: '30px'
                                        },0);
                                    });             
                        ...
                        if(blockstatus=="none"){
                            ...
                            box.animate({
                                ...
                                obj.slideDown("fast");
//                                if(index%2==0){
//                                    obj.css("background-color","#fff").children("a").css("color","#848484");
//                                }else{
//                                    obj.css("background-color","#F1F1F1").children("a").css("color","#848484");
//                                }
