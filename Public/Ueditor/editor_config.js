...
,toolbars:[["FullScreen","Source","Undo","Redo","Bold","Italic","Underline","StrikeThrough","Superscript","Subscript","ForeColor","BackColor","InsertOrderedList","InsertUnorderedList","SelectAll","RowSpacingTop","RowSpacingBottom","LineHeight","CustomStyle","Paragraph","FontFamily","FontSize","Indent","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","Link","Unlink","Anchor","ImageNone","ImageLeft","ImageRight","ImageCenter","InsertImage","SnapScreen","background","Emotion","Date","Time","Spechars","|","Horizontal","InsertTable","DeleteTable","MergeCells","SplittoCells","Preview","SearchReplace"]]
